...
class PostTest extends WebTestCase
{
    public function testPostPageWorks(): void
    {
        ...
        $client->request(
            Request::METHOD_GET,
            $urlGeneratorInterface->generate('blog.show', ['slug' => $post->getSlug()])
        );
    ...
    public function testReturnToBlogWorks(): void
    {
        ...
        $this->assertResponseIsSuccessful();
        $this->assertResponseStatusCodeSame(Response::HTTP_OK);
        $this->assertRouteSame('blog.index');
    }
    ...
    public function testShareOnFacebookWorks(): void
    {
        ...
        $postLink = $urlGeneratorInterface->generate('blog.show', ['slug' => $post->getSlug()]);
